...
var qaeSchema = /** @class */ (function () 
{
    ...
    qaeSchema.prototype.parseTransaction = function (txdata, bkdata, qdb)
    {
        ...
        return new Promise((resolve, reject) => {
            ...
            if (vendorData && vendorData.qae1 && blockData.height >= activationHeight)
            {
                ...
                */
                ...
                if (contractData.tp == 'GENESIS')
                {
                    ...
                    if (contractData.pa && typeof(contractData.pa) === "boolean")
                    {
		    ...
		    {
		       if (this.pausableActivationHeight > blockData.height)
		       {
		       ...
		       else
		       {
                    ...
                    if (contractData.mi && typeof(contractData.mi) === "boolean")
                    {
		    ...
		    {
		       if (this.mintableActivationHeight > blockData.height)
		       {
