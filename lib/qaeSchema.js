                            ...
                            else
                            {
                                ...
                                if (failed === false)
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        await qdb.updateDocument('addresses', {"recordId": recordId }, {"tokenBalance": recipientbalance.toString(), "lastUpdatedBlock": blockData.height });
                                ...
                                if (failed === false)
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        else 
                                        {
                                            ...
                                            await qdb.updateDocument('addresses', {"recordId": rrecordId }, {"tokenBalance": recipientbalance.toString(), "lastUpdatedBlock": blockData.height });
