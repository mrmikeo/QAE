...
// QAE-1 / QAE-2 Schema and Functions
// ==========================
...
var qaeSchema = /** @class */ (function () 
{
	...
	const Qae2TransactionTypeHeight = {
		"GENESIS": 6849840, 
		"PAUSE": 6849840,
		"RESUME": 6849840,
		"NEWOWNER": 6849840,
	...
	const Qae2TokenDetails = Interface('Qae2TokenDetails')({
		schema_version: type('number'),
		ownerAddress: type('string'),
		tokenIdHex: type('string'),
		versionType: type('number'),
	...
	const Qae2TokenStats = Interface('Qae2TokenStats')({
		schema_version: type('number'),
		block_created_height: type('number'),
		block_created_id: type('string'),
	...
	const Qae2TokenObject = Interface('Qae2TokenObject')({
		schema_version: type('number'),
		type: type('string'),
		paused: type('boolean'),
		parent: type('string'),
		tokenDetails: type('object', Qae2TokenDetails),
		tokenStats: type('object', Qae2TokenStats),
		lastUpdatedBlock: type('number')
	},{
		error: true,
		strict: true
	...
	const Qae2AddressObject = Interface('Qae2AddressObject')({
		schema_version: type('number'),
		recordId: type('string'),
		address: type('string'),
		tokenIdHex: type('string'),
	...
	const Qae2MetaDetails = Interface('Qae2MetaDetails')({
		schema_version: type('number'),
	...
	const Qae2MetaObject = Interface('Qae2MetaObject')({
		schema_version: type('number'),
		txid: type('string'),
		blockId: type('string'),
		blockHeight: type('number'),
		metaDetails: type('object', Qae2MetaDetails)
	},{
		error: true,
		strict: true
	});
	...
	const Qae2TransactionDetails = Interface('Qae2TransactionDetails')({
		schema_version: type('number'),
		transactionType: type('string'),
		senderAddress: type('string'),
		tokenIdHex: type('string'),
	...
	const Qae2TransactionObject = Interface('Qae2TransactionObject')({
		schema_version: type('number'),
		txid: type('string'),
		blockId: type('string'),
		blockHeight: type('number'),
		valid: type('boolean'),
		invalidReason: type('string'),
		transactionDetails: type('object', Qae2TransactionDetails)
	},{
		error: true,
		strict: true
	});
	...
	qaeSchema.prototype.getQae2TransactionTypes = function ()
	{
		
		return Qae2TransactionType;
	...
	qaeSchema.prototype.parseTransaction = function (txdata, bkdata, qdb)
	{
		...
		return new Promise((resolve, reject) => {
				...
				*/
				...
				if (contractData.tp == 'GENESIS')
				{
					...
					for(var costHeight in QaeGenesisCostHeight)
					{
						...
						{
							GenesisTransactionCost = Big(QaeGenesisCostHeight[costHeight]);
						}
					}
				...
				else
				{
					...
					else if (contractData.tp == 'MINT' && transactionData.recipient == QaeMasterAddress)
					{
						...
						(async () => {
							...
							var findToken = await qdb.findDocument('tokens', { $and: [ { "tokenDetails.tokenIdHex": tokenId }, { "type": "QAE1" } ] });
					...
					else if (contractData.tp == 'FREEZE' && transactionData.recipient != QaeMasterAddress)
					{
					...
					else if (contractData.tp == 'UNFREEZE' && transactionData.recipient != QaeMasterAddress)
					{
					...
					else if ((contractData.tp == 'FREEZE' || contractData.tp == 'UNFREEZE') && transactionData.recipient == QaeMasterAddress)
					{
						...
						(async () => {
							...
							var TransactionObject = {
								...
								blockHeight: blockData.height,
								valid: false,
								invalidReason: 'QAE1 Token - This command must be sent to the address which to take action,',
								transactionDetails: TransactionDetails
							}
					...
					else if ((contractData.tp == 'GENESIS' || contractData.tp == 'MINT' || contractData.tp == 'BURN' || contractData.tp == 'PAUSE' || contractData.tp == 'RESUME') && transactionData.recipient != QaeMasterAddress)
					{
			...
			/* QAE-2 Parser */
			if (vendorData && vendorData.qae2 && blockData.height >= activationHeightQae2)
			{
		
				var contractData = vendorData.qae2;
				...
				*/
				...
				if (!Qae2TransactionType[contractData.tp])
				{
					// Invalid Type
				...
				if (Qae2TransactionTypeHeight[contractData.tp] > blockData.height)
				{
					// Invalid Type
				...
				if (contractData.tp == 'GENESIS')
				{
					...
					// Check Transaction Cost
					var GenesisTransactionCost = Big(1);
					for(var costHeight in Qae2GenesisCostHeight)
					{
						console.log(costHeight + ": " + Qae2GenesisCostHeight[costHeight]);
				
						var bigCostHeight = Big(costHeight);
						var bigTestHeight = Big(blockData.height);
						if (bigTestHeight.gte(bigCostHeight))
						{
							GenesisTransactionCost = Big(Qae2GenesisCostHeight[costHeight]);
						}
					}
					...
					{
						if (pausableActivationHeightQae2 > blockData.height)
						{
							contractData.pa = true;
						}
						else
				...
				else if (contractData.tp == 'ADDMETA')
				{
				...
				else
				{
					...
					if (contractData.tp == 'GENESIS' && transactionData.recipient == QaeMasterAddress)
					{
						...
						var rawTokenId = 'QAE2.' + contractData.sy + '.' + blockData.height + '.' + transactionData.id;
						var tokenId = SparkMD5.hash(rawTokenId);
						...
						try 
						{
							...
							implement(Qae2TransactionDetails)(TransactionDetails);
						...
						try 
						{
							...
							implement(Qae2TokenDetails)(TokenDetails);
						...
						try 
						{
							...
							implement(Qae2TokenStats)(TokenStats);
						...
						try 
						{
							...
							implement(Qae2TokenObject)(TokenObject);
						...
						try 
						{
							...
							implement(Qae2AddressObject)(AddressObject);
						...
						try 
						{
							...
							implement(Qae2TransactionObject)(TransactionObject);
					...
					else if (contractData.tp == 'PAUSE' && transactionData.recipient == QaeMasterAddress)
					{
						...
						(async () => {
							...
							var findToken = await qdb.findDocument('tokens', { $and: [ { "tokenDetails.tokenIdHex": tokenId }, { "type": "QAE2" } ] });
					...
					else if (contractData.tp == 'CLONE' && transactionData.recipient == QaeMasterAddress)
					{
						...
						(async () => {
							...
							else
							{
								...
								else
								{
									...
									var rawTokenIdClone = 'QAE2.' + contractData.sy + '.' + blockData.height + '.' + transactionData.id;
									...
									try 
									{
										...
										implement(Qae2TransactionDetails)(TransactionDetailsclone);
...
//////
									...
									try 
									{
										...
										implement(Qae2TransactionObject)(TransactionObjectClone);
					...
					else if (contractData.tp == 'ADDMETA' && transactionData.recipient == QaeMasterAddress)
					{
						...
						(async () => {
							...
							try {
								...
								var chunkNumber = Big(contractData.ch);
								
							} catch (e) {
							
								var chunkNumber = Big(0);
								...
								if (failed === false)
								{
									...
									else
									{
										...
										try 
										{
											...
											implement(Qae2MetaDetails)(MetaDetails);
										...
										try 
										{
											...
											implement(Qae2MetaObject)(MetaObject);
										...
										var newTokenMetas = await qdb.findDocumentCount('metadata', {"tokenIdHex": tokenId });
					...
					else if (contractData.tp == 'AUTHMETA' && transactionData.recipient != QaeMasterAddress)
					{
					...
					else if (contractData.tp == 'REVOKEMETA' && transactionData.recipient != QaeMasterAddress)
					{
					...
					else if ((contractData.tp == 'AUTHMETA' || contractData.tp == 'REVOKEMETA') && transactionData.recipient == QaeMasterAddress)
					{
						...
						(async () => {
							...
							var TransactionObject = {
								...
								blockHeight: blockData.height,
								valid: false,
								invalidReason: 'QAE2 Token - This command must be sent to the address which to take action,',
								transactionDetails: TransactionDetails
							}
							...
							// Invalid command
							console.log("QAE2 - Invalid Command");
					...
					else if ((contractData.tp == 'GENESIS' || contractData.tp == 'CLONE' || contractData.tp == 'ADDMETA' || contractData.tp == 'PAUSE' || contractData.tp == 'RESUME') && transactionData.recipient != QaeMasterAddress)
					{
						...
						(async () => {
							...
							var TransactionObject = {
								...
								blockHeight: blockData.height,
								valid: false,
								invalidReason: 'QAE2 Token - This command must be sent to the Master QAE Address: ' + QaeMasterAddress,
								transactionDetails: TransactionDetails
							}
					...
					else
					{
						...
						(async () => {
							...
							var TransactionObject = {
								...
								blockHeight: blockData.height,
								valid: false,
								invalidReason: 'QAE2 Token - Invalid Command',
								transactionDetails: TransactionDetails
							}
